		...
		<>
			<div className='flex flex-col py-3 bg-white'>
				<small className='flex text-sm gap-2 items-center font-bold text-purple-900'>
					...
					<Link>Network & Security</Link>
					<BiChevronRight className='mt-1 hidden sm:flex' />
			...
			<div className='flex flex-col sm:w-4/5 xsm:mx-auto xsm:grid xsm:grid-cols-1 gap-3 lg:grid lg:grid-cols-2 lg:w-full lg:gap-6 lg:px-2 mt-1'>
				...
				<div className='flex flex-col gap-3'>
					<h2 className='bold font-bold  text-2xl sm:text-[2rem]'>
						Amazon AppStream 2.0 - Introduction
					</h2>
					<p className='text-xl'>
						An introduction to Amazon AppStream 2.0 and how to quickly leverage this
						AWS service
					</p>
					<div className='flex flex-col gap-2'>
						<small className='flex flex-wrap items-center text-sm gap-2'>
							...
							<span className='flex items-center'>
								<strong className='text-[#BB7725]'>4.5</strong> <Rating /> (193 ratings)
								10,416 students
							</span>
						...
						<small className='text-sm'>
							Created by{" "}
							<Link to={`/user/james`} className='text-purple-900 font-semibold'>
								James Scanlon | Masters Of Cloud
							</Link>
						</small>
