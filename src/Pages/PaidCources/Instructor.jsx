...
function Instructor({ course, loadindCourse }) {
	...
	return (
		<>
			...
			<div className='space-y-4 '>
				<div
					className={`w-full flex flex-col ${!isOpen && "h-64 overflow-y-hidden"}`}>
					<div>
						<HashLink
							to={`/user/${course?.author?.id}`}
							className='text-purple-700 border-b w-auto border-b-black font-bold text-lg'>
							{course?.author?.userName}
						</HashLink>
					</div>
					<h2 className='text-slate-700 mt-1'>
					...
					<div className='mt-2 space-y-2 text-sm'>
						<p className='text-sm'>
							Hi, I'm Jonas! I have been identified as one of Udemy's Top Instructors
							and all my premium courses have earned the best-selling status for
							outstanding performance and student satisfaction.
						</p>
						<p className='text-sm'>
							I'm a full-stack web developer and designer with a passion for building
							beautiful things from scratch. I've been building websites and apps since
							2010 and also have a Master's degree in Engineering.
						</p>
						<p className='text-sm'>
							I discovered my passion for teaching and helping others by sharing all I
							knew when I was in college, and that passion brought me to Udemy in 2015
						</p>
					</div>
				</div>
